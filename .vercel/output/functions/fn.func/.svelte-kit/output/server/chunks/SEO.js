import { c as create_ssr_component, i as escape, j as add_attribute, f as each, b as spread, e as escape_object, h as subscribe, v as validate_component } from "./ssr.js";
import { P as PUBLIC_SITE_NAME, b as PUBLIC_SITE_DESCRIPTION } from "./public.js";
...
const SEO = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { title = "" } = $$props;
  let { description = PUBLIC_SITE_DESCRIPTION } = $$props;
  let { og = true } = $$props;
  ...
  if ($$props.description === void 0 && $$bindings.description && description !== void 0)
    $$bindings.description(description);
  if ($$props.og === void 0 && $$bindings.og && og !== void 0)
    $$bindings.og(og);
  $$unsubscribe_page();
